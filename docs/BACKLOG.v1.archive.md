> **ARCHIVED.** This is the original implementation backlog. It is no longer
> maintained and is not part of the normal workflow. Kept for reference only —
> consult on demand or when diagnosing a hard bug to see how a feature was first
> built. New work does not follow this file.
